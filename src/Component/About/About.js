            ...
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 order-2 order-lg-1">
                    ...
                    <p class="font-italic text-muted mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
                        do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><Link to="#"
                        class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</Link>
                </div>
    ...
    <div class="bg-light py-5">
        <div class="container py-5">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-6 sm-2 about-mem">
                    <div class="bg-white rounded shadow-sm py-5 px-4"><img
                        ...
                        <ul class="social mb-0 list-inline mt-3">
                            <li class="list-inline-item"><Link to="#" class="social-link"><i
                                        class="fa fa-facebook-f"></i></Link></li>
                            <li class="list-inline-item"><Link to="#" class="social-link"><i
                                        class="fa fa-twitter"></i></Link></li>
                            <li class="list-inline-item"><Link to="#" class="social-link"><i
                                        class="fa fa-instagram"></i></Link></li>
                            <li class="list-inline-item"><Link to="#" class="social-link"><i
                                        class="fa fa-linkedin"></i></Link></li>
                        </ul>
                    </div>
                </div>
