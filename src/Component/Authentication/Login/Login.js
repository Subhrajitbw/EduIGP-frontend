      ...
      <section className="vh-100">
        <div className="container h-custom">
          <div className="row d-flex justify-content-center align-items-center h-100">
            ...
            <div className="container col-md-8 col-lg-6 col-xl-4 offset-xl-1">
              <form onSubmit={loginHandler}>
                ...
                <div className="form-outline mb-3 ">
                  ...
                  />
                  <label class="form-label" for="form3Example3">Email Password</label>
                </div>
                ...
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <div className="form-check mb-0">
                    <input
                      ...
                      id="form2Example3"
                    />
                    <label className="form-check-label remember" for="form2Example3">
                      Remember me
                    </label>
                  </div>
                  <div>
                  <a href="#!" className="text-body f-psw">
                    Forgot password?
                  </a>
                  </div>
                </div>
